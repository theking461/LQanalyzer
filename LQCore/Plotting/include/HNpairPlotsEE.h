#ifndef HNpairPlotsEE_h
#define HNpairPlotsEE_h
...
class HNpairPlotsEE : public StdPlots{
 ...
 public:
  ...
  /// copy constructor
  HNpairPlotsEE(const HNpairPlotsEE& sp);  ///Copy constructor
  /// assigment operator
  HNpairPlotsEE& operator=(const HNpairPlotsEE& obj);
