...
#sktree -a HN_pair_MM -S DoubleMuon -list dilepton_list_suoh -s SKTree_DiLepSkim -q fastq 
#sktree -a HN_pair_MM -S DoubleMuon -list suoh_list -s SKTree_DiLepSkim -q fastq
sktree -a HN_pair_MM -S DoubleMuon -s SKTree_DiLepSkim -fake True -q fastq
#sktree -a HN_pair_MM -S DoubleMuon -s SKTree_DiLepSkim -q fastq
#sktree -a HN_pair_MM -S DoubleMuon -s SKTree_DiLepSkim -n 1
#sktree -a HN_pair_MM -S DoubleMuon -s SKTree_DiLepSkim -fake True -n 1
#sktree -a HN_pair_MM -S DoubleMuon -s SKTree_DiLepSkim -p H_v3 -q fastq
